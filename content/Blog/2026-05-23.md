...
I can just use `blog` to open a (blank or existing) blog post for today. I can use `publish` to push it to the Web. I can use `mdvim "Firth"` to sequentially open all Markdown files containing a particular string - useful for keeping rationalising tags. 

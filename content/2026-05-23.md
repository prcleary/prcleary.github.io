...
I can just use `blog` to open a (blank or existing) blog post for today. I can use `publish` to push it to the Web.

```bash
blog() {
  local blog_dir="$HOME/prcleary.github.io/content"
  local date
